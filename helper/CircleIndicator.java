...
public class CircleIndicator extends View implements pIndi {
    ...
    public CircleIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultPageColor = res.getColor(R.color.gray);
        final int defaultFillColor = res.getColor(R.color.white);
        final int defaultOrientation = 1;
        final int defaultStrokeColor = res.getColor(android.R.color.transparent);
        final float defaultStrokeWidth = 0;
        final float defaultRadius = Misc.dpToPx(context, 4);
    ...
    public void setOrientation(int orientation) {
        switch (orientation) {
            case SCROLL_AXIS_HORIZONTAL:
            case SCROLL_AXIS_VERTICAL:
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mOrientation == SCROLL_AXIS_HORIZONTAL) {
            longSize = getWidth();
